...
import avatar from "../assets/img/AvatarIcon.jpg"
  ...
  return (
    <div id="Comment_display_box">
                <div className="row row-cols-2">
                  <div className="col d-sm-flex justify-content-xxl-start" style={{maxWidth: '65px'}}><img className="creator_avatar_icon" src={avatar} style={{borderColor: '#955c18'}} /></div>
