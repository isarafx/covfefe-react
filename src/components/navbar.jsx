        ...
        <div className={`sidebar ${sidebarActive ? "active": ""}`}>
          ...
          <nav className="navbar navbar-dark navbar-expand">
            <div className="container-fluid">
              ...
              <Link to="/commu-main"><li className="nav-item"><a onClick={()=>{setSidebarActive(false); setOverlayActive(false)}} className="nav-link" style={{fontSize: '19px', marginBottom: '5px'}}><i className="fas fa-globe" />&nbsp; {t("Menu03")}</a></li></Link>
